...
namespace Assets.NewData.Scripts
{
    public class RoomGeneratorBehaviour : MonoBehaviour, IPlayerPositionEvent
    {
        ...
        readonly string[] roomNames =
        {
            ...
            "Tier01/NormalRoom 8",
            "Tier01/NormalRoom 9",
            "Tier01/NormalRoom 10",
            "Tier01/NormalRoom 11",
            "Tier01/NormalRoom 12",
            "Tier01/NormalRoom 13",
            "Tier01/NormalRoom 14",
            "Tier01/NormalRoom 15",
            "Tier01/NormalRoom 16",
            "Tier01/NormalRoom 17",
            "Tier01/NormalRoom 18",
            "Tier01/NormalRoom 19",
            "Tier01/NormalRoom 20",
            "Tier01/NormalRoom 21",
            "Tier01/NormalRoom 22",
            "Tier01/NormalRoom 23",
            "Tier01/NormalRoom 24",
            "Tier01/NormalRoom 25",
            "Tier01/NormalRoom 26",
            "Tier01/NormalRoom 27",
            "Tier01/NormalRoom 28",
            "Tier01/NormalRoom 29",
            "Tier01/NormalRoom 30",
            "Tier01/NormalRoom 31",
            "Tier01/NormalRoom 32",
            "Tier01/NormalRoom 33",
            "Tier01/NormalRoom 34",
            "Tier01/NormalRoom 35",
            "Tier01/NormalRoom 36",
            "Tier01/NormalRoom 37",
        };
